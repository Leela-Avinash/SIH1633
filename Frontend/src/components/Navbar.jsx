...
function Navbar(){
    ...
    return(
        ...
        <div className="flex items-center pl-0 md:pl-20 sm:mx-0 mx-auto ml-5 sm:ml-0">
            ...
            <h1 className="pl-0 text-xl font-bold">Alumni<span className="text-custom1 text-xl"><span className="text-3xl"> C</span>onnect</span></h1>
        </div>
        <div class="hidden sm:block flex ml-auto space-x-6 lg:ml-auto lg:pr-40 pr-5">
        <a href="#" className="text-custom1 transition-colors duration-300 font-bold custom-underline hover:text-custom1">Home</a>
    ...
    <div className="mx-auto flex flex-col justify-center bg-transparent space-y-4 pt-5 pb-5">
    <a href="#" className="pl-5 w-full text-start text-custom1 transition-colors duration-300 font-bold custom-underline hover:text-custom1">Home</a>
