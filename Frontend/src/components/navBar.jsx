  ...
  return (
    <nav className="fixed top-0 z-50 w-full flex items-center bg-white text-black p-4">
      <div className="text-xl font-bold text-custom1 pl-4 flex text-center w-60">
        <div>
      <img src="../logo1.svg" className="h-14 w-14" alt="logo" /></div>
    ...
    <div>
          <button onClick={() => onNavClick('mentorship')} className="hover: flex items-center">
              {/* Replace with the provided SVG */}
              <div className='flex flex-col items-center  hover:text-custom1 fill-current'>
            <div>
              <svg 
    ...
    <div>
          <button onClick={() => onNavClick('forums')} className="hover: flex items-center">
              {/* Replace with the provided SVG */}
              <div className='flex flex-col items-center  hover:text-custom1 fill-current'>
